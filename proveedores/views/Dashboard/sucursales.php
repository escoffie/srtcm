...
$xcrud->table('sucursales_suc');
$xcrud->table_name('Sucursales');
//$xcrud->default_tab('Sucursales');
//$xcrud->where('id_rol<=',2);
//$xcrud->columns('id_rol,avatar_pro',true);
//$xcrud->unset_add();
$xcrud->unset_csv();
$xcrud->unset_remove();
$xcrud->label('codigo_sucursal_suc', 'ID Oracle');
$xcrud->label('nombre_oracle_suc','Nombre Oracle');
$xcrud->label('tipo_suc','Tipo de sucursal');
$xcrud->label('estado_suc','Estado');
$xcrud->label('region_suc','Región');
$xcrud->label('nombre_suc','Nombre de la sucursal');
//$xcrud->readonly('codigo_sucursal_suc,nombre_oracle_suc');
$xcrud->after_insert('generaSucursales');
$xcrud->after_update('generaSucursales');
//$xcrud->fields('id_rol', true);
//$xcrud->fields('fecha_pro', true);
//$xcrud->fields('avatar_pro', true);
//$xcrud->change_type('id_niv','checkboxes');
//$xcrud->change_type('tipo_suc','datetime');
...
//Proveedores
$suc = $xcrud->nested_table('Proveedores', 'codigo_sucursal_suc', 'empresa_sucursal_proveedor_esp', 'codigo_sucursal_suc');
$suc->table_name("Acceso a proveedores");
//$suc->join('codigo_pro','proveedores_pro','codigo_pro');
$suc->label(array(
...
$suc->relation('codigo_pro', 'proveedores_pro', 'codigo_pro', array('razonsocial_pro','rfc_pro'),'','','',' - ');
