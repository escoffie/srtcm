...
{
    // default connection
    public static $dbname = 'surticom_crm'; // Your database name
    public static $dbuser = 'surticom_admin'; // Your database username
    public static $dbpass = 'Racatapulfuf1?'; // // Your database password
    ...
    public static $upload_folder_def = '../userfiles/contenido'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    // alert settings
    public static $email_from = 'mailer@surticoma.com'; // email from address
